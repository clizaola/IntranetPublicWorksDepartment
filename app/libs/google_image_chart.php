...
class GoogleChart { 
    ...
    public $types = array( 
                            ...
                            'bar-horizontal' => 'bhg', 
                            'bar-vertical' => 'bvg',
                            'bar-horizontal-apilada' => 'bhs', 
                            'bar-vertical-apilada' => 'bvs',
                            'venn' => 'v'
                        ); 
	...
	public $icon_image;
	public $icon_text;
	public $icon_color_background;
	public $icon_color_text;
    ...
    */ 
    ...
    { 
        ...
        $this->query = array( 
                            ...
                            'chbh'  => 'a',
                            'chst'  => $this -> icon,
                            'chld'  => $this -> icon_image.'|bb|'.$this -> icon_text.'|'.substr($this -> icon_color_background,1).'|'.substr($this -> icon_color_text,1)
        ); 
    ...
    */ 
    ...
    {
    	return Html::imagen($url,$alt,$this->size[0],$this->size[1]);
