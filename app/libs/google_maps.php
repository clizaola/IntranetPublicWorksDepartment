<?php
	...
	*/
	...
	class GoogleMaps{
		...
		public static function input($nombre, $x = false, $y = false, $zoom = false, $w = 500, $h = 500, $editable = true){
			Load::lib("formulario");
			
			if($editable) $editable = "true"; else $editable = "false";
			...
			$code .= Formulario::texto($nombre,$x || $y ? "(".$x.", ".$y.")" : "","style: visibility: hidden; height; 1px;");
